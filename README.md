...
│
├── src/                          # Source code
│   ├── Interface1.9.py           # Main application
│   ├── uiInterfaceFinal.py       # UI generated by Qt Designer (pyuic5)
│   ├── InterfaceFinal.ui         # Editable Qt Designer file
│   └── Logo_Unesp.svg.png        # UNESP logo used by the interface
│
├── Interface1.9.spec             # PyInstaller configuration file
├── System Block Diagram.tif      # System block diagram
├── Data Acquisition.tif          # Data acquisition diagram
├── Welding Control System.png    # Screenshot of the main interface
├── Process Report.txt            # Example of raw process data log
├── Process Report.pdf            # Example of automatically generated report
│
├── .gitignore
├── LICENSE                       # MIT License
└── README.md
